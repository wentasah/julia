...
getfield_tfunc(@nospecialize(s00), @nospecialize(name)) = _getfield_tfunc(s00, name, true)
function _getfield_tfunc(@nospecialize(s00), @nospecialize(name), allow_module::Bool)
